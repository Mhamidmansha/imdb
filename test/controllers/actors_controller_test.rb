...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { age: @actor.age, bdy: @actor.bdy, email: @actor.email, first_name: @actor.first_name, last_name: @actor.last_name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { age: @actor.age, bdy: @actor.bdy, email: @actor.email, first_name: @actor.first_name, last_name: @actor.last_name } }
